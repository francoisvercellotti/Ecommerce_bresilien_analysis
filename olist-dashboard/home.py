    ...
    with col1:
            st.markdown(
                ...
                <div class='metric-card metric-card-customers'>
                    ...
                    <div class='metric-value'>{int(metrics['order_count']):,}</div>
                </div>
                """,
                unsafe_allow_html=True
            )
    ...
    with col2:
        st.markdown(
            ...
            <div class='metric-card metric-card-spend'>
                ...
                <div class='metric-value'>{int(metrics['total_revenue']):,}</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col3:
        st.markdown(
            ...
            <div class='metric-card metric-card-frequency'>
                ...
                <div class='metric-value'>{format_currency(metrics['avg_order'])}</div>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col4:
        st.markdown(
            ...
            <div class='metric-card metric-card-clv'>
                ...
                <div class='metric-value'>{metrics['avg_delivery_days']:.1f}</div>
            </div>
            """,
            unsafe_allow_html=True
        )
